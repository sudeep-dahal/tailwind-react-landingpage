    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-green-400 w-[200px] font-medium my-6 mx-auto px-6 py-3 rounded-md'>Start Trial</button>
                ...
                <div className='bg-gray-100 w-full shadow-xl flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-black w-[200px] font-medium my-6 mx-auto px-6 py-3 rounded-md text-green-600'>Start Trial</button>
